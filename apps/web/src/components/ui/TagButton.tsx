...
export const TagButton = ({ label, active = false, onClick }: TagButtonProps) => {
  ...
  const activeClasses = "bg-emerald-500 border-emerald-400 [box-shadow:0_6px_0_0_#2d9f74,0_8px_0_0_#56d68f] ";
  const inactiveClasses = "bg-gray-500 border-gray-600 [box-shadow:0_2px_0_0_#333333,0_4px_0_0_#444444] ";
