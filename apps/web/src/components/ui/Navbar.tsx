        ...
        {isSidebarOpen && (
          ...
          >
            ...
            <nav className="flex-1 flex flex-col items-center justify-center gap-6 text-lg font-medium">
              <Link onClick={toggleSidebar} href="/" className="hover:text-emerald-400">
                Inicio
              </Link>
              <Link onClick={toggleSidebar} href="/about" className="hover:text-emerald-400">
                Acerca de nosotros
              </Link>
              <Link onClick={toggleSidebar} href="/objectives" className="hover:text-emerald-400">
                Objetivos
              </Link>
              <a onClick={toggleSidebar} href="#" className="hover:text-emerald-400">
                Servicios
              </a>
              {isAuthenticated ? (
                <DropDown
                ...
                <div className="flex flex-col gap-3">
                  <Button variant="solid" as="link" to="/auth/login" onClick={toggleSidebar}>
                    Iniciar sesión
                  </Button>
                  <Button variant="outline" as="link" to="/auth/register" onClick={toggleSidebar}>
                    Crear cuenta
                  </Button>
                </div>
              )}
